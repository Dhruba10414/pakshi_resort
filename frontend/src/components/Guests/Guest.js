...
function Guest({id, name, phone, address, openTicketModal, openInvoiceModal, openFoodOrderModal}) {
  return (
    <div className="aguest">
      ...
      <div className="options">
          ...
          <button className="buy-tickets" onClick={() => openTicketModal(id)}>Buy tickets</button>
